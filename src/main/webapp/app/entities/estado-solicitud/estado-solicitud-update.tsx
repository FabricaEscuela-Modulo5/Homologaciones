  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="lab32023App.estadoSolicitud.home.createOrEditLabel" data-cy="EstadoSolicitudCreateUpdateHeading">
            Create or edit a Estado Solicitud
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="estado-solicitud-id" label="ID" validate={{ required: true }} />
              ) : null}
              <ValidatedField
                label="Id Estado Solicitud"
