...
export const MateriaSolicitudDetail = () => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2 data-cy="materiaSolicitudDetailsHeading">Materia Solicitud</h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="idSemestrePasada">Id Semestre Pasada</span>
          </dt>
