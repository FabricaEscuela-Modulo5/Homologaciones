  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="lab32023App.planEstudios.home.createOrEditLabel" data-cy="PlanEstudiosCreateUpdateHeading">
            Create or edit a Plan Estudios
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="plan-estudios-id" label="ID" validate={{ required: true }} />
              ) : null}
              <ValidatedField label="Version" id="plan-estudios-version" name="version" data-cy="version" type="text" />
              <ValidatedField
