...
public class SituacionAcademicaResource {
    ...
    public ResponseEntity<SituacionAcademica> updateSituacionAcademica(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, situacionAcademica.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SituacionAcademica> partialUpdateSituacionAcademica(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, situacionAcademica.getId().toString())
        );
    }
