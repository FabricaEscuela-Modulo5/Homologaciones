...
public class EstadoSemestreResource {
    ...
    public ResponseEntity<EstadoSemestre> updateEstadoSemestre(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, estadoSemestre.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EstadoSemestre> partialUpdateEstadoSemestre(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, estadoSemestre.getId().toString())
        );
    }
