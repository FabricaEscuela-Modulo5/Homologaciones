...
public class RelacionResource {
    ...
    public ResponseEntity<Relacion> updateRelacion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, relacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Relacion> partialUpdateRelacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, relacion.getId().toString())
        );
    }
