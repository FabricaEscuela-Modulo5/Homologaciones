...
public class MateriaSemestreResource {
    ...
    public ResponseEntity<MateriaSemestre> updateMateriaSemestre(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materiaSemestre.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MateriaSemestre> partialUpdateMateriaSemestre(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materiaSemestre.getId().toString())
        );
    }
