...
public class MateriaSolicitudResource {
    ...
    public ResponseEntity<MateriaSolicitud> updateMateriaSolicitud(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materiaSolicitud.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MateriaSolicitud> partialUpdateMateriaSolicitud(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, materiaSolicitud.getId().toString())
        );
    }
