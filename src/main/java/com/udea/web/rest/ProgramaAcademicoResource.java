...
public class ProgramaAcademicoResource {
    ...
    public ResponseEntity<ProgramaAcademico> updateProgramaAcademico(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, programaAcademico.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ProgramaAcademico> partialUpdateProgramaAcademico(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, programaAcademico.getId().toString())
        );
    }
