...
public class TipoSemestreResource {
    ...
    public ResponseEntity<TipoSemestre> updateTipoSemestre(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoSemestre.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TipoSemestre> partialUpdateTipoSemestre(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoSemestre.getId().toString())
        );
    }
