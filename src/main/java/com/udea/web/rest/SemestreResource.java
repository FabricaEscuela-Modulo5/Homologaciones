...
public class SemestreResource {
    ...
    public ResponseEntity<Semestre> updateSemestre(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, semestre.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Semestre> partialUpdateSemestre(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, semestre.getId().toString())
        );
    }
