...
public class TercioResource {
    ...
    public ResponseEntity<Tercio> updateTercio(@PathVariable(value = "id", required = false) final Long id, @RequestBody Tercio tercio)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tercio.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Tercio> partialUpdateTercio(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tercio.getId().toString())
        );
    }
