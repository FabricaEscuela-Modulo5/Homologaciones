...
public class EstadoSolicitudResource {
    ...
    public ResponseEntity<EstadoSolicitud> updateEstadoSolicitud(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, estadoSolicitud.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EstadoSolicitud> partialUpdateEstadoSolicitud(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, estadoSolicitud.getId().toString())
        );
    }
