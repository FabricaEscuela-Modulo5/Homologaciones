...
public class SolicitudHomologacionResource {
    ...
    public ResponseEntity<SolicitudHomologacion> updateSolicitudHomologacion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, solicitudHomologacion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SolicitudHomologacion> partialUpdateSolicitudHomologacion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, solicitudHomologacion.getId().toString())
        );
    }
